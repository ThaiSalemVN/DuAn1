...
public class MainJFrame extends javax.swing.JFrame {
    ...
    DoanhThuJIFrame doanhThuJIFrame;
    Xe_TrangThaiJIFrame hangTonJIFrame;
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/nhom8/icon/Alarm.png"))); // NOI18N
        jLabel1.setText("11:11:30");
        ...
        mniHoaDon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/nhom8/icon/List.png"))); // NOI18N
        ...
        mniDoanhThu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/nhom8/icon/Dollar.png"))); // NOI18N
        ...
        mniHangTon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/nhom8/icon/Bar chart.png"))); // NOI18N
        mniHangTon.setText("Số lượng xe chưa bán");
        mniHangTon.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mniHangTonActionPerformed(evt);
            }
        });
        mnuThongKe.add(mniHangTon);
        ...
        mniBanHang.setIcon(new javax.swing.ImageIcon(getClass().getResource("/nhom8/icon/Add to basket.png"))); // NOI18N
    ...
    private void mniKhachHangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mniKhachHangActionPerformed
        if (khachHangJIFrame == null || khachHangJIFrame.isClosed()) {
            khachHangJIFrame = new KhachHangJIFrame();
...
//                    this.getHeight() / 2 - xeJIFrame.getHeight() / 2);
    ...
    private void mniHoaDonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mniHoaDonActionPerformed
        if (banHangJIFrame==null || banHangJIFrame.isClosed()) {
              banHangJIFrame = new BanHangJIFrame();
    ...
    private void mniDoanhThuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mniDoanhThuActionPerformed
        if (doanhThuJIFrame == null || doanhThuJIFrame.isClosed()) {
            doanhThuJIFrame = new DoanhThuJIFrame();
    ...
    private void mniHangTonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mniHangTonActionPerformed
         if (hangTonJIFrame == null || hangTonJIFrame.isClosed()) {
            hangTonJIFrame = new Xe_TrangThaiJIFrame();
            Desktop.add(hangTonJIFrame);
               hangTonJIFrame.setLocation(Desktop.getWidth()/2 -hangTonJIFrame.getWidth()/2,
                Desktop.getHeight()/2 - hangTonJIFrame.getHeight()/2 );
            hangTonJIFrame.setVisible(true);
        }
